...
class BreakfastScreen extends React.Component{
 ...
 render(){
  return(
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
      ...
      <Text style = {styles.pic}>Breakfast</Text>

      <TouchableOpacity onPress = {()=> this.props.navigation.navigate('Food')} style = {styles.back}>
